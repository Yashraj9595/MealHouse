...
import '../features/user/home/presentation/pages/user_home_container.dart';
...
import '../features/user/data/models/mess_model.dart';
import '../features/user/data/models/meal_group_model.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> get routes => {
    ...
    userHomeScreen: (context) => const ProtectedRoute(
      requiredRole: UserRole.user,
      child: UserHomeContainer(),
    ),
    messDetailScreen: (context) {
      final args = ModalRoute.of(context)!.settings.arguments as MessModel;
    ...
    mealGroupDetailScreen: (context) {
      final args = ModalRoute.of(context)!.settings.arguments as UserMealGroupModel;
