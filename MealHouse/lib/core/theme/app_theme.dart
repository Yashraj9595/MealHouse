...
class AppTheme {
  ...
  // Primary color palette - Zomato Red
  static const Color primaryLight = Color(0xFFE23744);
  static const Color primaryVariantLight = Color(0xFFCB202D);
  static const Color onPrimaryLight = Color(0xFFFFFFFF);

  // Secondary color palette
  static const Color secondaryLight = Color(0xFF212121);
  static const Color secondaryVariantLight = Color(0xFF000000);
  ...
  // Dark theme colors
  static const Color primaryDark = Color(0xFFE23744);
  static const Color primaryVariantDark = Color(0xFFCB202D);
  static const Color onPrimaryDark = Color(0xFFFFFFFF);

  static const Color secondaryDark = Color(0xFFEEEEEE);
  static const Color secondaryVariantDark = Color(0xFFFFFFFF);
